...
to cultivate
  ...
  ifelse (Area = "Germany") [
    ...
    if (Scenario = "Basic")
     ...
     if (Scenario = "Miscanthus")
     [
     set cropProbability [["wheat" 0.442] ["maize" 0.299] ["grassland" 0.149] ["alfalfa" 0.008] ["beets" 0.002] ["miscanthus" 0.100]] ; ["rape" 0.000]
     ]

     if (Scenario = "Grass-clover ley")
     [
     set cropProbability [["wheat" 0.442] ["maize" 0.278] ["grassland" 0.149] ["rape" 0.021] ["alfalfa" 0.008] ["beets" 0.002] ["grass-clover ley" 0.100]]
     ]

     if (Scenario = "Alfalfa")
     [
     set cropProbability [["wheat" 0.442] ["maize" 0.301] ["grassland" 0.149] ["alfalfa" 0.100] ["beets" 0.002]] ;["rape" 0.000]
     ]
